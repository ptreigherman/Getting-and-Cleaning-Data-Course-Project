Variables 3-68 below represent the average observation for each subject and each activity across all variables from the original data set (training and test sets combined).
